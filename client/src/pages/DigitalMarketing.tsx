...
import digitalbanner from "@/assets/images/digital.jpg";
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <nav className="text-sm text-white/70">
            <span>Services</span> <span className="text-purple-400">→</span> <span>Digital Marketing</span>
          </nav>
        </div>
      </div>
    </section>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <h3 className="text-3xl md:text-4xl font-bold">
              Empowering Businesses with <span className="gradient-text"> Result-Driven Digital Marketing</span>
            </h3>
            <p className="text-lg text-[var(--body-color)] leading-relaxed">
           We design strategic digital marketing campaigns that do more than just reach people — they engage, convert, and grow your brand. From SEO and social media to paid ads and content marketing, our team uses data-backed strategies to drive real business results. </p>
            <p className="text-lg text-[var(--body-color)] leading-relaxed">
           Whether you're launching a new product or scaling your online presence, we deliver customized marketing solutions that attract the right audience and turn clicks into loyal customers.
  ...
  const techCategories = [
    {
      ...
      icon: TrendingUp,
      technologies: ["Google Ads", "Facebook Ads", "Instagram Ads", "LinkedIn Ads", "Twitter Ads", "YouTube Ads"],
      color: "from-[var(--theme-primary)] to-[var(--theme-secondary)]"
    },
    {
      title: "SEO & Analytics",
      icon: Brain,
      technologies: ["Google Analytics", "Google Search Console", "SEMRush", "Ahrefs", "Moz", "Hotjar"],
      color: "from-[var(--theme-secondary)] to-[var(--theme-accent)]"
    },
    {
      title: "Email & Automation",
      icon: Bot,
      technologies: ["Mailchimp", "HubSpot", "ActiveCampaign", "SendGrid", "Zapier", "ConvertKit"],
      color: "from-[var(--theme-accent)] to-[var(--theme-primary)]"
    },
    {
      title: "Content & Social Tools",
      icon: Code,
      technologies: ["Canva", "Buffer", "Hootsuite", "Grammarly", "WordPress", "Google Trends"],
      color: "from-[var(--theme-primary)] to-[var(--theme-accent)]"
    }
  ];
  ...
  return (
    <section className="py-20 bg-[var(--black-deep)]">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-8">
            Our <span className="gradient-text">Digital Marketing</span> Stack
          </h2>
          <p className="text-xl text-[var(--body-color)] max-w-3xl mx-auto">
            We use the latest marketing platforms, analytics, automation, and content tools to grow your brand online.
          </p>
        </div>
  ...
  const steps = [
    {
      ...
      description: "We understand your business goals, target audience, and market to create a custom digital marketing strategy.",
      icon: Lightbulb
    },
    {
      number: "02", 
      title: "Campaign Planning",
      description: "We design and plan campaigns across SEO, social media, paid ads, and email to maximize your reach.",
      icon: Code
    },
    {
      number: "03",
      title: "Execution & Optimization",
      description: "We launch campaigns, monitor performance, and optimize for best results using analytics and A/B testing.",
      icon: Zap
    },
    {
      number: "04",
      title: "Reporting & Growth",
      description: "We provide detailed reports and insights, helping you scale and improve your digital marketing ROI.",
      icon: Shield
    }
  ];
  ...
  return (
    <section className="py-20 bg-[var(--black-secondary)]">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-8">
            Our Digital Marketing <span className="gradient-text">Process</span>
          </h2>
          <p className="text-xl text-[var(--body-color)] max-w-3xl mx-auto">
            We follow a proven digital marketing workflow to deliver measurable results and business growth.
          </p>
        </div>
